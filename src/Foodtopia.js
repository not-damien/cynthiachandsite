...
export default function Foodtopia(){
    return (
        <div>
           ...
           <section>
            <p>User Testing Results: Users want a way to adjust text, save recipes, and have a back button. They also wanted a way to swap what side the hamburger menu is on, along with making pictures clickable as links to the recipe alongside the text.</p>
            <div className="center">
                <h2>High Fidelity Prototype </h2>
                <p>View the Foodtopia high fidelity prototype</p>
            </div>
            <p>
            Conclusions and Next Steps: The next step I’d like to take for this project is to create a high fidelity mockup for account settings and a help/FAQ page to get a better sense for how this app will feel as a whole. I’d also like to work on editing my transitions to make them more seamless.
            </p>
           </section>
        </div>
